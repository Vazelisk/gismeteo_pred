...
# о погоде для одного города на 24 дня
...
# создает словарь с прогнозами load_forecast для 24 городов
...
# и выбирает город с самой высокой
# если есть совпадения, то берется последний по алфавиту
